	...
	public static void main(String[] args) {
		...
		// FileWriter out	=new FileWriter(p.toString());
		   ...
		   List<String> naw=Arrays.asList("بشت", "تجوري", "دلاغ" ,"ابجور" ,"أبجور", "دريول", "فريزر" , "بصم"  ,"بلكون ", "بخت", "تليفون" , "تلفزيون"  ,"خوش" ,  "روج" , "ساندويش", "سندويش"  );// non Arabic words without prefix & suffix 
			List<String> stopwordsList = Arrays.asList("ام"	,"بدون"	,"عشرة",	"على",	"مقابل"	,"حاليا"	,"التى"	,"حوالى"	,"الماضي",
		            "انا",	"ب",	"عند"	,"اذا",	"هذا",	"امس"	,"ايام",	"انها",
					"انها",	"مافيه",	"لان"	,"عندما"	,"احد"	,"هاذا",	"السابق"	,"خلال","جميع",
					"شي"	,"مافي",	"اثر"	,"عليه",	"برس"	,"بن",	"التي"	,"الذين"	,"الوقت",
					"ع",	"انا"	,"ا"	,"عاما",	"بسبب",	"بشكل",	"الا"	,"الان"	,"اول",
					...
					"مثل"	,"لهاذا" ,	"عشر"	,"تم"	,"اطار"	,"او"	,"الذاتي"	,"دون",	"قد",
					"مره" ,	"انت"	,"راح"	,"عدم",	"اعادة"	,"اجل"	,"حيث",	"الذى",	
					...
					"وقد" ,	"وقال"	,"كلم",	"وهو"	,"وهي",	"يوم"	,"نهاية"	,"لقاء"	,
					"نفسه"	, "وكان"	,"زيارة"	,"غدا",	"ثم",	"ايار"	,"الاولى"	,"اليوم"	,
					"لهذا"	,"بكره"	,"بعض"	,"بان"	,"صفر"	,"الثانية","الف","ما","يا","يومياً","كل","إذا","علي","عليك","عليهم","عليكم");
			 List<Character> vowels= Arrays.asList ('ا','ي','و');
			 List<String> nostemming=Arrays.asList("اللهُ","الله"); // words must not to be stemmed 	
		   int lettercount=0;
		   String word=null;
